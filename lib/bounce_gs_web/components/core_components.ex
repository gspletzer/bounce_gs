defmodule BounceGsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BounceGsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BounceGsWeb.Gettext, "errors", msg, opts)
    end
  end
